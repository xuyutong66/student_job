...
class SendMessage
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIKsAk94OiXGz5"; // AccessKeyId

        $accessKeySecret = "f9pdHkn3JM154u8rOTgpOOkkGuXKxk"; // AccessKeySecret
